...
--
-- Host: localhost    Database: pokeestelar
-- ------------------------------------------------------
...
CREATE DATABASE IF NOT EXISTS `pokeEstelar`;
USE `pokeEstelar`;
