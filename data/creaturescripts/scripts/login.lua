...
--	end
	...
	if player:getBackpacks() > 10 then
		player:teleportTo(Position(710, 786, 7))
...
--	end
	...
	-- addEvent(botCheck, 5*60*1000, player.uid)

	-- Announces
	player:sendTextMessage(MESSAGE_EVENT_ADVANCE, "Seja bem-vindo(a) ao Poke Estelar")
