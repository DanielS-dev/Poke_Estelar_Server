...
enum ConditionType_t {
	...
	CONDITION_SILENCE = 1 << 31, //helena
	CONDITION_REFLECT = 19, //helena
	CONDITION_COAT = 3, //helena
	CONDITION_FOCUS = 5, //helena
	CONDITION_EVASION = 7, //helena
	CONDITION_DEFENSEPLUS = 9, //helena
	CONDITION_DEFENSEMINUS = 11, //helena
	CONDITION_ATTACKPLUS = 13, //helena
	CONDITION_ATTACKMINUS = 15, //helena
	CONDITION_IMMUNE = 17, //helena
	CONDITION_STURDY = 21, //helena
	CONDITION_SAFFARI = 23, //helena
	CONDITION_PARK = 25, //helena
	CONDITION_FISHING = 27, //helena
};
