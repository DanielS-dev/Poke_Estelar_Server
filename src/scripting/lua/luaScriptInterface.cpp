...
{
	switch (code) {
		case LUA_ERROR_PLAYER_NOT_FOUND: return "Player not found"; // Helena - Erro de addEvent nao achar a criatura, nada demais.
		case LUA_ERROR_CREATURE_NOT_FOUND: return "Creature not found"; // Helena - Erro de addEvent nao achar a criatura, nada demais.
